...
/*
 * struct file_slice - one slices of a file
 ...
 * in all the slices increaed on success. Returns NULL on failure.
 */
...
/*
 * file_get_by_tag() - Finds a file based on tag and increace reference counter
 * @tag:	Tag of the file
 * @taglen:	Length of @tag
 *
 ...
 *
 * If a matching file slices is found it's returned, else NULL is returned.
 */
